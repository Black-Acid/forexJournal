...
class TradesModel(models.Model):
    ...
    lot_size = models.DecimalField(decimal_places=4, max_digits=7)
    original_position_size = models.DecimalField(decimal_places=4, max_digits=7)
    ...
    commission_usd = models.DecimalField(decimal_places=4, max_digits=8)
    swap_usd = models.DecimalField(decimal_places=3, max_digits=8)
    profit_usd = models.DecimalField(decimal_places=3, max_digits=20)
